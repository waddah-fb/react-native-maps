...
export const googleMapIsInstalled = !!NativeModules.UIManager.getViewManagerConfig(getAirMapName(PROVIDER_GOOGLE));
...
export default function decorateMapComponent(Component, { componentType, providers }) {
  ...
  Component.prototype.getUIManagerCommand = function getUIManagerCommand(name) {  // eslint-disable-line no-param-reassign,max-len
      return NativeModules.UIManager.getViewManagerConfig(getAirComponentName(this.context.provider, componentType))
      .Commands[name];
  };
